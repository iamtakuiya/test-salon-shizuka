...
export default function StoreInfoProto() {
  ...
  // The JavaScript "Wheel Translation" Approach
  ...
  useEffect(() => {
    ...
    const handleWheelScroll = (event: WheelEvent) => {
      // Only intercept if the user is scrolling vertically with a wheel/trackpad
      if (event.deltaY !== 0) {
    ...
    // Add the listener directly to the element node with passive: false
